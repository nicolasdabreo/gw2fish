...
export default function Fish({ fishItem, catchData }) {
  const timeOfDay = tyriaTimeOfDay()

  return ['Any', timeOfDay].includes(catchData.time) && (
    <li key={fishItem.name} className='flex col-span-1 rounded-md shadow-sm'>
